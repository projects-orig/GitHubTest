...
data_obj={
  "HostSetting":
    {"update":{"network_set": "2", "static_ip": "192.168.159.111", "static_mask": "255.255.255.0", "static_gate": "192.168.159.1"}
  }
}
...
data_obj={
  "HostSetting":{
    "update":{"network_set": "6",  "sim_password":"??", "pin_code":"???"}
  }
}
'''
...
data_obj={
  "HostSetting":{
    "update":{"network_set": "4", "wifi_ssid":"APP_GR267Z_2.4G", "wifi_pass":""}
  }
}

data_obj={
  "HostSetting":{
    "update":{"network_set": "4", "wifi_ssid":"SW_470n", "wifi_pass":"12345678"}
  }
}
'''
